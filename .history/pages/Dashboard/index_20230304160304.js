...
const index = () => {
  return (
    <>
      ...
      <div className="max-w-screen-sm py-64 mx-auto bg-stone-100 text-black overflow-hidden">
        <div className="flex flex">
          <div className="flex justify-center py-2 mb-9">
          ...
          <div className="flex justify-center my-9">
            <div className="border-2 rounded-2xl flex justify-start mx-5 px-10 py-5">
              <div className="">
            ...
            <div className="border-2 rounded-2xl justify-start mx-5 px-10 py-5 text-left">
              ...
              <p className="text-5xl font-bold">
                25 791{" "}
                <span className="text-stone-600 font-medium text-lg">BDT</span>
              </p>
            </div>
          </div>
          <div className="flex justify-center my-9">
            <div className="border-2 rounded-2xl justify-start mx-5 px-10 py-5">
              ...
              <p className="text-5xl font-bold">59 213</p>
            </div>
            <div className="border-2 rounded-2xl justify-start mx-5 px-10 py-5 text-left">
              <p className="uppercase text-stone-600 font-normal text-xl">
                Product views
              </p>
              <p className="text-5xl font-bold">25 791</p>
            </div>
          </div>
          <div>
            <h1 className="text-3xl mx-16">Recent Orders</h1>
          </div>
        </div>
      </div>
    </>
