  ...
  return (
    <div className=" max-w-screen-sm bg-white mx-auto">
      <div className="drawer h-fit">
        ...
        <div className="drawer-side bg-white mt-20 absolute left-5">
          <label htmlFor="my-drawer" className="drawer-overlay"></label>
          <ul className="menu p-4 w-80 bg-white text-black">
            <li className="">
              <Link href="">
                <img src="https://i.ibb.co/sjm1dwr/home-button.png" />
                Dashboard
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link href="">
                <img src="https://i.ibb.co/5M3RVCZ/two-people.png" />
                Customers
              </Link>
            </li>
            <li>
              <Link href="">
                <img src="https://i.ibb.co/GCHhHwH/settings.png" />
                Settings
              </Link>
            </li>
          </ul>
